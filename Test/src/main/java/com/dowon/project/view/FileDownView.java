package com.dowon.project.view;
...
import com.dowon.project.file.dto.FileDto;

/*
 *  [ View 를 만드는 방법 ]
 *  
 *  - AbstractView 추상 클래스를 상속 받는다.
 *  - @Component("bean  의 이름 지정")
 *  - ModelAndView 객체에 담은 모델은 Map 객체로 전달된다.
 *  - servlet-context.xml 에 BeanNameViewResolver 설정
 */

@Component("fileDownView") //bean 의 이름 지정하기 
public class FileDownView extends AbstractView{
	...
	protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request,
		...
		//ServletContext 객체의 참조값 (jsp 페이지에서는 기본객체)
